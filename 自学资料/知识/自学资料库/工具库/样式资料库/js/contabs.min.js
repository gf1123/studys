$(function() {
    ...
    function g1(n) {
        var o = f($(n).prevAll()),
        q = f($(n).nextAll());
        var l = f($(".content-tabs",window.parent.document).children().not(".J_menuTabs"));
    ...
    function c1() {
        ...
        if (k) {
             ...
             var n = '<iframe class="J_iframe" name="iframe0'+ '" width="100%" height="100%" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
 			...
 			g1($(".J_menuTab.active",window.parent.document))
        }
        return false
    }
    $(".J_menuItem").on("click", c);
    //内部弹出tab标签
    $(".J_menuItem_cet").on("click", c1);
    function h() {
